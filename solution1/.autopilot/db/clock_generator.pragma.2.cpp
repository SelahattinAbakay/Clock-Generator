# 1 "clock_generator-vhls/clock_generator.cpp"
# 1 "clock_generator-vhls/clock_generator.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 152 "<built-in>" 3
# 1 "<command line>" 1
...
# 9 "<command line>" 2
# 1 "<built-in>" 2
# 1 "clock_generator-vhls/clock_generator.cpp" 2
# 1 "clock_generator-vhls/clock_generator.h" 1
# 2 "clock_generator-vhls/clock_generator.cpp" 2
...
_ssdm_op_SpecInterface(out_clock, "ap_none", 0, 0, "", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
