...
HD_PWD='D:/vivado_hls/clock_generator-vhls/clock_generator.runs/design_1_clock_generator_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_clock_generator_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_clock_generator_0_0.tcl
